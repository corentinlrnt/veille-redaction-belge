...
Le registre initial est un échantillon de travail, pas une liste définitive. Il combine institutions politiques, juridictions, producteurs de statistiques, organismes économiques et acteurs de terrain. Les médias et les sources internationales seront ajoutés après validation de cette première mécanique.
...
Une erreur sur un site distant est enregistrée dans le rapport sans faire échouer l’ensemble du traitement. Une erreur de schéma dans les registres provoque en revanche un échec explicite.
...
3. Indiquer la date du dernier contrôle manuel et la portée du contenu.
4. Lancer les tests et la sonde.
5. Vérifier les conditions d’utilisation avant toute collecte plus riche que ce contrôle de métadonnées.
