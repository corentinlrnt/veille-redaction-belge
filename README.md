...
- le briefing final doit séparer les informations incontournables, les pas de
  côté, l'agenda pertinent, les signaux repérés hors presse et les projets à
  mettre en chantier.
...
La chaîne distingue désormais trois étages. Le radar déterministe réduit plusieurs milliers d'éléments à un ensemble traçable de candidats. Le paquet éditorial retire ensuite le score lexical et fournit au modèle la provenance, les limites des extraits, les huit moteurs d'angle et le contrat du futur courriel. Dans la même fenêtre glissante de 36 heures, une voie réservée réintroduit jusqu'à huit publications par producteur institutionnel, judiciaire, scientifique, syndical ou associatif afin qu'elles ne disparaissent pas derrière le volume de la presse. Une autre voie, sans quota par producteur, isole les événements officiels du jour et des 36 prochaines heures à partir de leur date de tenue : séances parlementaires, réunions, audiences et publications annoncées. La Chambre est couverte par son agenda plénier officiel et par l'API publique de ses réunions vidéo planifiées. Ces signaux frais peuvent nourrir un pas de côté du jour ou ouvrir un projet froid de plusieurs jours. Enfin, la sortie du modèle passe par un validateur déterministe avant tout archivage ou rendu : schéma, date, rangs, provenance des liens et usage réel des voies primaire et agenda sont contrôlés. Le fournisseur de modèle reste interchangeable et l'envoi du courriel n'est pas encore activé.
