...
Généré le `2026-09-18T04:28:13.177626Z` par `veille-redaction-belge/0.1.0`.

- Accès configurés et actifs : **286**
- Accès testés : **286**
- Accès opérationnels : **219**
- Accès en erreur ou bloqués : **67**
...
| Antenne Centre Télévision | Actualités régionales | `ok` | 200 | `html → html` | `allowed` | 0 |
...
| Banque nationale de Belgique | Communiqués de presse | `ok` | 200 | `html → html` | `allowed` | 3 |
...
| Chambre des représentants | Agenda de la séance plénière | `http_error` | 403 | `html → unknown` | `allowed` | 0 |
| Chambre des représentants | Agenda des commissions | `http_error` | 403 | `html → unknown` | `allowed` | 0 |
| Chambre des représentants | Réunions vidéo planifiées | `ok` | 200 | `chamber_live → json` | `unknown` | 0 |
...
| Conseil central de surveillance pénitentiaire | Actualités | `ok` | 200 | `html → html` | `allowed` | 1 |
| Conseil central de surveillance pénitentiaire | Avis | `ok` | 200 | `html → html` | `allowed` | 1 |
| Conseil central de surveillance pénitentiaire | Publications | `ok` | 200 | `html → html` | `allowed` | 1 |
| Conseil d'État | Actualités | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
| Conseil de l'Union européenne | Calendrier des réunions | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
| Conseil de l'Union européenne | Communiqués de presse | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
| Conseil de l'Union européenne | Portail du Conseil de l'Union européenne | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
| Conseil de l'Union européenne | Répertoire des flux RSS | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
| Conseil des Femmes Francophones de Belgique | Actualités et prises de position | `ok` | 200 | `html → html` | `allowed` | 0 |
| Conseil européen | Portail du Conseil européen | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
| Conseil européen | Réunions du Conseil européen | `http_error` | 403 | `html → unknown` | `unknown` | 0 |
...
| De Morgen | Home en nieuws | `ok` | 200 | `html → html` | `allowed` | 0 |
| De Morgen | In het nieuws | `ok` | 200 | `rss → rss` | `allowed` | 0 |
...
| Défenseur des droits de l'enfant | Actualités et publications | `ok` | 200 | `html → html` | `allowed` | 0 |
...
| FGTB | Presse | `http_error` | 418 | `html → unknown` | `allowed` | 0 |
...
| GrenzEcho | Accueil et actualités | `ok` | 200 | `html → html` | `allowed` | 0 |
| GRIP | Recente artikels | `ok` | 200 | `html → html` | `allowed` | 0 |
| Groen | Flux des actualités | `ok` | 200 | `rss → rss` | `allowed` | 0 |
| Het Belang van Limburg | Nieuwsfeed | `ok` | 200 | `rss → rss` | `allowed` | 0 |
...
| L'Echo | Flux actualité | `ok` | 200 | `rss → rss` | `allowed` | 0 |
| L'Echo | Répertoire des flux RSS | `ok` | 200 | `html → html` | `allowed` | 10 |
| La Libre Belgique | Accueil et actualités | `ok` | 200 | `html → html` | `allowed` | 1 |
...
| Sudinfo | Accueil et actualités | `ok` | 200 | `html → html` | `allowed` | 0 |
| Sudinfo | Flux principal | `ok` | 200 | `rss → rss` | `allowed` | 0 |
| Sénat de Belgique | Actualités institutionnelles | `ok` | 200 | `html → html` | `allowed` | 0 |
| Team Fouad Ahidar | Page publique Instagram | `blocked_by_robots` | — | `html → unknown` | `disallowed` | 0 |
...
| Union nationale des mutualités socialistes Solidaris | Nieuws Solidaris Vlaanderen | `ok` | 200 | `html → html` | `allowed` | 0 |
| UNIZO | Nieuws | `ok` | 200 | `html → html` | `allowed` | 0 |
...
| Voka | Nieuws | `ok` | 200 | `html → html` | `allowed` | 0 |
| Vooruit | Nieuws | `http_error` | 403 | `html → unknown` | `allowed` | 0 |
| VRT NWS | Flux VRT NWS | `ok` | 200 | `atom → atom` | `allowed` | 0 |
| VRT NWS | VRT NWS | `ok` | 200 | `html → html` | `allowed` | 0 |
| VTM NIEUWS | VTM NIEUWS | `ok` | 200 | `html → html` | `allowed` | 0 |
| Wallonie Entreprendre | Actualités | `ok` | 200 | `html → html` | `allowed` | 0 |
| Wallonie-Bruxelles Enseignement | Actualités | `blocked_by_robots` | — | `html → unknown` | `disallowed` | 0 |
| Wirtschafts- und Sozialrat der Deutschsprachigen Gemeinschaft | Aktuelles | `ok` | 200 | `html → html` | `allowed` | 1 |
| Wonen in Vlaanderen | Nieuws | `ok` | 200 | `html → html` | `allowed` | 0 |
