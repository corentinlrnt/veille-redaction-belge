...
À ce stade, seuls les flux publics explicitement publiés par Médor et Apache sont collectés dans ce nouveau lot. Les pages des autres magazines et médias spécialisés sont sondées, mais n'alimentent pas automatiquement le briefing tant qu'un flux ou un adaptateur public fiable n'a pas passé les contrôles. Cette distinction évite de faire passer un simple référencement pour une collecte effective.
